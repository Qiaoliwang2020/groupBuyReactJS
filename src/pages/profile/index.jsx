...
import { AtButton,AtAvatar,AtList,AtListItem,AtTabBar,AtTag} from 'taro-ui'
    ...
    return (
      <View className='profile-view'>
        ...
        <View className='profile-list bg-white mt-20 border-radius-12'>
          <AtListItem hasBorder={false}  title='我发布的团购' arrow='right' />
          <AtTabBar
            fontSize='12'
            color='#666666'
            tabList={[
          ...
          />
          <AtListItem className='top-line-item' hasBorder={false}  title='我参与的团购' arrow='right' />
        </View>
